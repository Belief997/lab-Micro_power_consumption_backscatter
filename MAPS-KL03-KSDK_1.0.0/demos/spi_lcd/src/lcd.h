...
#include <stdio.h>
#include "spi_master/fsl_spi_master_driver.h"
...
#define LCD_CS_HIGH()       GPIO_HAL_SetPinOutput(GPIOA_BASE,12)
#define LCD_CS_LOW()        GPIO_HAL_ClearPinOutput(GPIOA_BASE,12)
#define LCD_CD_HIGH()       GPIO_HAL_SetPinOutput(GPIOA_BASE,8)
#define LCD_CD_LOW()        GPIO_HAL_ClearPinOutput(GPIOA_BASE,8)
...
void LCD_UpdatePoint(unsigned int x, unsigned int y, unsigned char data);
